...
// Default configuration values for Vault storage
const (
	DefaultMountPath  = "kv"    // Default mount path for Vault KV v2 engine
...
type options[T any] struct {
	cas                  bool
	mountPath            string                           `optgen:"default=DefaultMountPath" optval:"timspaces,trimprefix=/"`
	secretPath           string                           `optgen:"default=DefaultSecretPath" optval:"timspaces,trimprefix=/"`

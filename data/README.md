...
Data layer for the Atlas framework. Provides storage abstractions, caching, filtering, distributed locks, leader election, rate limiting,
idempotency, outbox pattern, probabilistic filters, and unique value storage.

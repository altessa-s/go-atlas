...
// BenchmarkTranslateInline_Complex measures the inline path against the
// same expression as BenchmarkTranslate_Complex — the difference is the
// cost of literal formatting versus placeholder collection.

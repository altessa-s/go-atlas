...
func (s *deadlineCapturingStore) DeleteProcessedEvents(context.Context, time.Duration) error {
	return nil
}
func (s *deadlineCapturingStore) UnlockStuckEvents(context.Context, time.Duration) error { return nil }

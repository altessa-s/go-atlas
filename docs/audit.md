...
Buffer size, batch size, workers, retries, and WAL are all on the `dispatch.Engine`. See [service/dispatch](../service/dispatch).
...
Full reference: [config/templates/audit.yaml](../config/templates/audit.yaml).
...
|-------------------------------------------------------------------|-----------------------------|
| [`data/audit`](../data/audit)                                     | Auditor, Event, Storage     |
| [`data/audit/factory`](../data/audit/factory)                     | Builder from config         |
| [`data/audit/storages/memory`](../data/audit/storages/memory)     | In-memory backend           |
| [`data/audit/storages/mongo`](../data/audit/storages/mongo)       | MongoDB backend             |
| [`transport/grpc/interceptors/audit`](../transport/grpc/interceptors/audit) | gRPC interceptor  |
| [`transport/http/server/middlewares/audit`](../transport/http/server/middlewares/audit) | HTTP middleware |
| [`service/dispatch`](../service/dispatch)                         | Async dispatch engine       |

...
// is intentionally not listed: tokens are verified with a public key, and
...
// defaultAllowedAlgorithms is the fail-closed default allow-list: asymmetric
// algorithms only.
var defaultAllowedAlgorithms = []Algorithm{AlgEdDSA, AlgES256, AlgRS256}

// DefaultAllowedAlgorithms returns a copy of the default accepted algorithms
// (EdDSA, ES256, RS256). HMAC is intentionally excluded.
func DefaultAllowedAlgorithms() []Algorithm { return slices.Clone(defaultAllowedAlgorithms) }

// methodNames maps an allow-list of algorithms to the string method names
// golang-jwt's parser expects.
func methodNames(algs []Algorithm) []string {
